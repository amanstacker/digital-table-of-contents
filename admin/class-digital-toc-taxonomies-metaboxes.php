	...
	public function __construct() {
		...
		if ( is_admin() ) {
			...
			foreach ( $this->_taxterm as $value ) {
				...
				add_action( "{$value}_edit_form_fields", array( $this, 'edit_form_fields' ),10,2 );
				add_action( "created_{$value}", array($this, "save_term_fields" ));
				add_action( "edited_{$value}", array($this, "save_term_fields" ));	
